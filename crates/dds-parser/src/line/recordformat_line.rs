...
impl From<(usize, &[char; 80])> for RecordFormatLine {
...
impl Display for RecordFormatLine {
...
impl IHighlight for RecordFormatLine {
...
impl ISpan for RecordFormatLine {
    fn span(&self) -> Span {
        Span::from((
            self.sequence.span(),
            self.keywords.span(),
